...
def analyze_transaction():
    try:
        ...
        blockchain_risk_percentage = int(blockchain_risk_score * 100)
        
        # Combined risk score (weighted average)
        combined_risk_score = (ml_risk_score * 0.7) + (blockchain_risk_score * 0.3)
        combined_risk_percentage = int(combined_risk_score * 100)
        
        # Get detailed risk analysis
        risk_analysis = get_detailed_risk_analysis(data, ml_risk_score, blockchain_risk_score)
        ...
        result = {
            ...
            "blockchain_risk_score": blockchain_risk_score,  # 0-1 scale
            "blockchain_risk_percentage": blockchain_risk_percentage,  # 0-100 for display
            "risk_level": get_risk_level(combined_risk_score),
            "confidence": get_confidence_score(ml_risk_score, blockchain_risk_score),
        ...
        logger.info(f"Analyzed transaction {result['transaction_id']} - Risk: {result['risk_level']} ({combined_risk_percentage}%)")
